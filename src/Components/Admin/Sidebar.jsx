    ...
    <div className="w-64 h-screen fixed left-0 top-0 bg-white border-r border-gray-200 p-4 flex flex-col">
      ...
      <div className="flex-grow overflow-y-auto">
        ...
        <Dropdown
          ...
          imgSrc={book} 
          links={[
            { imgSrc: book, path: "/admin/category-management", label: "Category Management" },
            { imgSrc: book, path: "/admin/request-book", label: "Request Book" },
            { imgSrc: grow, path: "/admin/view-book", label: "View Books" },
          ]}
        />
        ...
        <Dropdown
          ...
          imgSrc={box} 
          links={[
            { imgSrc: grow, path: "/admin/view-order", label: "View Orders" },
            { imgSrc: boxx, path: "/admin/order-status", label: "Order Status Update" },
          ]}
        />
        ...
        <Dropdown
          ...
          imgSrc={sell} 
          links={[
            { imgSrc: grow, path: "/admin/request-seller", label: "Request Seller" },
            { imgSrc: sell, path: "/admin/seller-status", label: "Seller Status" },
          ]}
        />
        ...
        >
          <img src={sell} alt="Customer Management" className="mr-3 h-5 w-5" />
