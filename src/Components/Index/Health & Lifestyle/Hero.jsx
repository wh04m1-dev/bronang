...
import C from '../../../Img/Index/Hero/Health.png';

const Hero = () => {
  return (
    <div className="max-w-screen-xl mx-auto px-4 py-8">
      <p className="text-lg font-bold mb-2">Categories</p>
      <h2 className="text-3xl font-bold mb-2">Health & Lifestyle</h2>
      ...
      <div className="flex flex-col md:flex-row border border-black  gap-4">
        ...
        <div className='ml-10 mt-10' >
          ...
          <h1 className="text-2xl mt-2 font-bold"> Health & Lifestyle </h1>
          <p className=" mt-2">
